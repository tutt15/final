...
<head>
		...
		<base href="{{asset('')}}">
		<!-- Bootstrap CSS -->
		<link href="{{asset('admin/admin/css/bootstrap.min.css')}}" rel="stylesheet" type="text/css" />
...
<script src="{{asset('admin/admin/js/modernizr.min.js')}}"></script>
